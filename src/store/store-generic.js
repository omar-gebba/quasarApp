const state = {
  generic: {
    ID1: {
      ...
      source2:
        "10417_‭١٤٩‬‭ص‌ر‌م‬_EGY_2019-07-30-13-56-31-428__1192_065_CTX_2.jpg",
      source3:
        "10417_‭١٤٩‬‭ص‌ر‌م‬_EGY_2019-07-30-13-56-31-428__1192_065_CTX_3.jpg",
      source4:
        "10415_‭١٤٩‬‭ص‌ر‌م‬_EGY_2019-07-30-13-53-31-428__1192_065_CTX_2.jpg",
      source5:
        "10415_‭١٤٩‬‭ص‌ر‌م‬_EGY_2019-07-30-13-53-31-428__1192_065_CTX_3.jpg",
      source6: " ",
      source7: " ",
      source8: " ",
...
/////////////////////////////////// MUTATIONS //////////////////////////////////////////////////
const mutations = {
  setSearch(state, value) {             ///search
    state.search = value;
  },
  defineSearch(state,value) {          /// search by a value
...
const actions = {
  setSearch({ commit }, value) {       ///search
    commit("setSearch", value);
  },
  defineSearch({commit}, value) {      ///serach by a value
...
const getters = {
  dataFiltered: state => {                /// filter data to search
    let datafiltered = {};
    if (state.search) {
      Object.keys(state.generic).forEach(function(key) {
        let data = state.generic[key],
  ...
  generic: (state, getters) => {
    let dataFiltered = getters.dataFiltered;
    return dataFiltered;
  }
};
